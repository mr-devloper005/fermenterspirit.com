      ...
      <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
          <div className="border border-[#dfcfbf] bg-[#fff7ef] p-8">
            <p className="text-xs uppercase tracking-[0.24em] text-[#8a6f5e]">Join As Author</p>
            <h1 className="mt-4 text-4xl font-semibold tracking-[-0.04em] text-[#2f1d16]">Create your publishing account</h1>
            <p className="mt-5 text-sm leading-8 text-[#6f5648]">
              Open your writer profile, publish stories, and grow a consistent audience with a clean article-first platform.
            </p>
          </div>

          <div className="border border-[#dfcfbf] bg-white p-8">
            <p className="text-xs uppercase tracking-[0.24em] text-[#8a6f5e]">Create account</p>
            <form className="mt-6 grid gap-4" onSubmit={handleSubmit}>
              <input value={name} onChange={(event) => setName(event.target.value)} className="h-12 rounded-xl border border-[#dbc6b6] bg-transparent px-4 text-sm" placeholder="Full name" />
